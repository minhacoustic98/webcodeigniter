                ...
                <div class="tab_container">
                    <div id="tab1" class="tab_content pd0">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                            <textarea name="title" id="title" class="editor"><?php echo $news->title ?></textarea>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="intro" id="intro" _autocheck="true" type="text" value="<?php echo $news->intro ?>"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight" style="display:grid">
                                <div class="left"><input type="file" id="image" name="image"></div>
                                
                                <div class="image-inside" >
                                    <img src="<?php echo base_url('upload/news/'.$news->image_link) ?>" style="height: 100px">
                                </div>
                            </div>
                            <div class="clear">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="created" id="created" _autocheck="true" type="text" value="<?=  date('d-m-Y', strtotime($news->created))?>"></span>
                                <span name="intro_autocheck" class="autocheck"></span>
                                <div name="intro_error" class="clear error">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input name="featured" id="featured" _autocheck="true" type="text" value="<?=$news->featured?>"  ></span>
                    ...
                    <div id="tab3" class="tab_content pd0">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <textarea name="content" id="content" class="editor"><?=$news->content?></textarea>
