                            ...
                            <table cellpadding="0" cellspacing="0" width="80%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="label" style="width:40px;"><label for="name">Tên</label></td>
                                        <td class="item" style="width:155px;"><input name="name" value="<?php echo $this->input->get('name') ?>" id="name" type="text" style="width:155px;"></td>
                ...
                <tr>
                    <td colspan="6">
                        <div class="list_action itemActions">
                            <a href="#submit" id="submit" class="button blueB" url="<?php echo admin_url('product/del_multi') ?>">
