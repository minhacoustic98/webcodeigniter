				...
				<form class="list_filter form" action="<?php echo current_url(); ?>" method="get">
					<table cellpadding="0" cellspacing="0" width="100%"><tbody>
						...
						<tr>
							...
							<td class="item">
								<select name="payment">
									...
									<option value='COD' <?php if(isset($filter['payment']) && $filter['payment']=='COD'){echo 'selected';}?>>Đặt hàng</option>
								</select>
							</td>
						...
						<tr>
							...
							<td class="item"><input name="user" value="<?php if(isset($filter['user_id'])){echo $filter['user_id'];}?>" id="filter_user" class="tipS"  type="text" /></td>
