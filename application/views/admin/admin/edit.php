    ...
    <div class="widget">
        ...
        <form class="form" id="form" action="" method="post" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="formRow">
                    <label class="formLeft" for="param_pass">Password:</label>
                    <div class="formRight">
                        ...
                        <i style="color:darkgreen">Nếu cập nhật mật khẩu, vui lòng điền thông tin</i>
                    </div>
                    <div class="clear"></div>
                </div>

                <div class="formRow">
                    <label class="formLeft" for="param_repass">Nhập lại mật khẩu:</label>
                    <div class="formRight">
