...
<div class="top"><!-- The top -->
      <div id="logo"><!-- the logo -->
           <a href="<?php echo base_url()?>" title="Bình An Media Mart">
	           <img src="<?php echo public_url() ?>site/images/binhan.png" alt="Logo" style="height:75px;">
	       </a>
       </div><!-- End logo -->
    ...
    <div class="clear"></div><!-- clear float --> 
           ...
           <ul class="menu_top">
                ...
                <li class=""><a href="<?=site_url('news/index')?>">Tin tức</a></li>
                <li class=""><a href="<?php echo base_url('contact') ?>">Liên hệ</a></li>
                <?php if($user_login):?>
                    
                    <li class="">Xin chào: <a href="<?php echo base_url('user') ?>"><?php echo $user_info->name ?></a></li>
