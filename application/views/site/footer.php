     ...
     <div id="footer_text"> <!-- The footer_text --> 
	     <strong>Siêu thị điện máy Bình An</strong>
		 <p>Chuyên cung cấp sản phẩm điện máy,điện tử,ti vi,laptop</p>
		 <p>Chất lượng dịch vụ tuyệt hảo</p>
		 <p>Sản phẩm chính hãng,giá cả hợp lý</p>
	 </div><!-- End footer_text -->
